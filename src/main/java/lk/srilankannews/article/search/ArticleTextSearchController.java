...
public class ArticleTextSearchController {
    private final ArticleTextSearchService service;

    public ArticleTextSearchController(ArticleTextSearchService service) {
        this.service = service;
    }

    @GetMapping
    public TextSearchResponse search(
